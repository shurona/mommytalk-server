...
public record EntitlementGroupListResponseDto(
    Long id,
    String title,
    String type,
    String product,
    ...
    public static EntitlementGroupListResponseDto of(Group groupInfo,
        Map<Long, Integer> groupPlatformUserCount, Map<Long, Integer> groupAllUserCount) {
        return EntitlementGroupListResponseDto.builder()
            .id(groupInfo.getId())
            .title(groupInfo.getName())
            .type(groupInfo.getGroupType().getCode())
            .product(groupInfo.getEntitlement().getName())
